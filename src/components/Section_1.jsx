...
export default function Section_1({ onPortfolioClick, onContactClick }) {
  ...
  return (
    <section className='relative mx-auto w-[92%] max-w-6xl px-2 pb-0 pt-5 md:px-0 md:pb-2 md:pt-6'>
      <div className='glass noise rounded-[36px] border border-white/10 px-5 py-8 shadow-glass md:px-7 md:py-8 xl:px-10 xl:py-12'>
        <div className='grid items-center gap-6 md:grid-cols-[1.05fr_0.95fr] xl:gap-10'>
          <div className='order-2 text-left md:order-1'>
            ...
            <h1 className='text-4xl font-semibold leading-[0.96] tracking-[-0.05em] text-white sm:text-5xl md:text-[3.35rem] lg:text-6xl xl:text-7xl'>
              Building immersive interfaces with clean motion and sharp front-end systems.
            </h1>

            <p className='mt-5 max-w-xl text-[15px] leading-7 text-muted sm:text-lg md:text-base'>
              {smallTextAboutMe}
            </p>
          ...
          <div className='order-1 flex justify-center md:order-2 md:justify-end'>
            <div className='neon-border relative flex h-[310px] w-[310px] items-center justify-center rounded-[38px] border border-white/10 bg-transparent p-5 sm:h-[360px] sm:w-[360px] md:h-[300px] md:w-[300px] lg:h-[380px] lg:w-[380px] xl:h-[410px] xl:w-[410px]'>
              <img
