...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  }, [ref, data]); // Depend on data to recalculate height dynamically
  ...
  return (
    <div className='w-full font-sans max-h-full' ref={containerRef}>
      ...
      <div ref={ref} className='relative max-w-7xl mx-auto pb-20'>
        {data.length > 0 ? (
          ...
          <div className='text-center py-10 text-neutral-500'>
            No entries yet. Stay tuned for updates!
          </div>
        )}
        ...
        >
          <motion.div
            ...
            className='md:absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-purple-500 via-blue-500 to-transparent from-[0%] via-[10%] rounded-full'
          />
        </div>
      </div>
    </div>
